...
import { parseTypeScript, findTsCalls } from './ast.js';
...
export async function loadCustomRules(projectRoot) {
...
export async function runCustomRules(projectRoot, context) {
