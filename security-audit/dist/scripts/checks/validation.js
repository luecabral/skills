...
export async function check(projectRoot, context) {
    ...
    const clientOnlyValidation = await grepInFiles(await globFiles(projectRoot, ['app/**/*.tsx', 'components/**/*.tsx', 'src/**/*.tsx'], context), /onSubmit.*validate|handleSubmit.*validate|client.side.*valid/i, context);
